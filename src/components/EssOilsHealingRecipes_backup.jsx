...
const convertVolume = (amount, fromUnit, toUnit) => {
  ...
  if (toUnit === 'oz') {
    return Math.round((mlAmount / 30) * 100) / 100;
  } else if (toUnit === 'tbsp') {
    return Math.round((mlAmount / 15) * 100) / 100;
  } else if (toUnit === 'tsp') {
    return Math.round((mlAmount / 5) * 100) / 100;
  } else {
...
const convertWeight = (amount, fromUnit, toUnit) => {
  ...
  if (fromUnit === 'oz') {
    gramAmount = amount * 28; // 1 oz = 28.3495 g
  } else {
    gramAmount = amount; // already in grams
  }
  
  if (toUnit === 'oz') {
    return Math.round((gramAmount / 28) * 100) / 100;
  } else {
